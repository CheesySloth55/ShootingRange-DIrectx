//globals
Texture2D shaderTexture1 : register(t0); // texture 1 to blend with 2
Texture2D shaderTexture2 : register(t1); // texture 2
Texture2D shaderTexture3 : register(t2); // texture 3 alpha map
